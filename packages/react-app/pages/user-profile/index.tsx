...
const UserProfile = () => {
  ...
  return (
    <div className="flex flex-row md:gap-10">
      ...
      <div className="bg-white md:mx-auto rounded shadow-xl w-full md:w-3/5 overflow-hidden md:-mt-10">
        <div className="h-[140px] bg-gradient-to-r from-slate-400 to-slate-500"></div>
        <div className="md:px-5 px-3 py-2 flex flex-col gap-3 pb-6">
          <div className="md:h-[90px] w-[50px] h-[50px] shadow-md md:w-[90px] rounded-full border-4 overflow-hidden -mt-14 border-white">
            <img
          ...
          <div className="flex flex-col md:flex-row justify-between gap-2">
            ...
            <div className="flex flex-col gap-3 ">
              ...
              <div className="flex gap-2 justify-end">
                ...
                <Link
                  href="/"
                  className="rounded-full border border-slate-500 bg-white  py-1.5 px-2 md:px-5 text-black transition-all hover:bg-white hover:text-black text-center text-sm font-inter flex items-center justify-center"
                >
                  Send Message
                </Link>
